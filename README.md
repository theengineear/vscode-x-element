...
2. Find any `customElements.define` expressions. and for each constructor, analyze
   the constructor (e.g., figure out it’s public property interface) and store a lookup from the tag name to the constructor name.
